...
merchant_agg AS (
    SELECT
        ...
        AVG(reports.time_to_first_contact) OVER Wunb AS avg_ra_time_first_reply_seconds_from_merchant_unbounded,
        AVG(reports.time_to_first_contact) OVER W90d AS avg_ra_time_first_reply_seconds_from_merchant_last_90d,
        AVG(reports.time_to_first_contact) OVER W60d AS avg_ra_time_first_reply_seconds_from_merchant_last_60d,
        AVG(reports.time_to_first_contact) OVER W30d AS avg_ra_time_first_reply_seconds_from_merchant_last_30d,
        AVG(reports.time_to_first_contact) OVER W15d AS avg_ra_time_first_reply_seconds_from_merchant_last_15d,
        AVG(reports.time_to_first_contact) OVER W7d AS avg_ra_time_first_reply_seconds_from_merchant_last_7d,  
        --Max time to first contact  in seconds    
        MAX(reports.time_to_first_contact) OVER Wunb AS max_ra_time_first_reply_seconds_from_merchant_unbounded,
        MAX(reports.time_to_first_contact) OVER W90d AS max_ra_time_first_reply_seconds_from_merchant_last_90d,
        MAX(reports.time_to_first_contact) OVER W60d AS max_ra_time_first_reply_seconds_from_merchant_last_60d,
        MAX(reports.time_to_first_contact) OVER W30d AS max_ra_time_first_reply_seconds_from_merchant_last_30d,
        MAX(reports.time_to_first_contact) OVER W15d AS max_ra_time_first_reply_seconds_from_merchant_last_15d,
        MAX(reports.time_to_first_contact) OVER W7d AS max_ra_time_first_reply_seconds_from_merchant_last_7d,  
        --Min time to first contact  in seconds    
        MIN(reports.time_to_first_contact) OVER Wunb AS min_ra_time_first_reply_seconds_from_merchant_unbounded,
        MIN(reports.time_to_first_contact) OVER W90d AS min_ra_time_first_reply_seconds_from_merchant_last_90d,
        MIN(reports.time_to_first_contact) OVER W60d AS min_ra_time_first_reply_seconds_from_merchant_last_60d,
        MIN(reports.time_to_first_contact) OVER W30d AS min_ra_time_first_reply_seconds_from_merchant_last_30d,
        MIN(reports.time_to_first_contact) OVER W15d AS min_ra_time_first_reply_seconds_from_merchant_last_15d,
        MIN(reports.time_to_first_contact) OVER W7d AS min_ra_time_first_reply_seconds_from_merchant_last_7d, 
